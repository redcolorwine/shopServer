...
const { DataTypes } = require('sequelize'); // для описания полей

//описываем модели и их поля
...
Clothes.hasMany(ClothesInfo, { as: 'info' }); //указываем название поля у массива характеристик
